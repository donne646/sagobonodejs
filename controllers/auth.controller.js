...
import mailer from '../helpers/mail.helper.js';
  ...
  try {
    ...
    if (account) {
      ...
      var mail = {
        ...
        to: account.email,
        subject: 'Sagobook',
        html: '<h1>Khôi phục mật khẩu</h1>' +
          '<p>Xin chào <b>' + account.username + '</b>,</p>' +
          '<p>Đã có yêu cầu khôi phục mật khẩu cho tài khoản của bạn liên kết với email ' + account.email + '.</p>' +
          '<p>Mật khẩu của bạn đã được đặt lại mặc định là <mark><b>'+newPassword+'</b></mark>. Vui lòng thay mật khẩu mới để bảo vệ tài khoản.</p>' +
